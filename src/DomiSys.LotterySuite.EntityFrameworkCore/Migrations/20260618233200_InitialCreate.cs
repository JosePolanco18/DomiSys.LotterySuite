    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_acumulados_venta_numero", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "configuraciones_monto_jugada",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TipoJugada = table.Column<int>(type: "integer", nullable: false),
                    MontoMinimo = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_configuraciones_monto_jugada", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoCorto = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PinVendedor = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Estado = table.Column<int>(type: "integer", nullable: false),
                    PorcentajeComisionVenta = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    PorcentajeComisionVerde = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    Ubicacion = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Telefono = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Notas = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    UltimaActividad = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "configuraciones_pago",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    LoteriaId = table.Column<Guid>(type: "uuid", nullable: false),
                    TipoJugada = table.Column<int>(type: "integer", nullable: false),
                    MultiplicadorPago = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_configuraciones_pago", x => x.Id);
                    table.ForeignKey(
                        name: "FK_configuraciones_pago_loterias_LoteriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoteriaId = table.Column<Guid>(type: "uuid", nullable: false),
                    Nombre = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    DiasActivos = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    HoraAperturaVentas = table.Column<TimeSpan>(type: "interval", nullable: false),
                    HoraCierreVentas = table.Column<TimeSpan>(type: "interval", nullable: false),
                    HoraSorteo = table.Column<TimeSpan>(type: "interval", nullable: false),
                    MinutosEsperaScraping = table.Column<int>(type: "integer", nullable: false),
                    Activo = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sorteos_loterias_LoteriaId",
                        column: x => x.LoteriaId,
                        principalTable: "loterias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "cuadres_terminal",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TerminalId = table.Column<Guid>(type: "uuid", nullable: false),
                    FechaCuadre = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    PeriodoInicio = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    PeriodoFin = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    VentasBrutas = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalPremiosPagados = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    PorcentajeComisionVenta = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    MontoComisionVenta = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    PorcentajeComisionVerde = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    MontoComisionVerde = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    BalanceNeto = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    QuedoEnVerde = table.Column<bool>(type: "boolean", nullable: false),
                    Notas = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CuadradoPor = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cuadres_terminal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_cuadres_terminal_terminales_TerminalId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CodigoTicket = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    TerminalId = table.Column<Guid>(type: "uuid", nullable: false),
                    FechaCreacion = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Estado = table.Column<int>(type: "integer", nullable: false),
                    MontoTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalPremios = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    FechaPago = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    TerminalPagoId = table.Column<Guid>(type: "uuid", nullable: true),
                    FechaAnulacion = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    AnuladoPor = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    MotivoAnulacion = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    HashVerificacion = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tickets_terminales_TerminalId",
                        column: x => x.TerminalId,
                        principalTable: "terminales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tickets_terminales_TerminalPagoId",
                        column: x => x.TerminalPagoId,
                        principalTable: "terminales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SorteoId = table.Column<Guid>(type: "uuid", nullable: false),
                    Numero = table.Column<int>(type: "integer", nullable: false),
                    LimiteVentaMaximo = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    LimiteAguante = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_limites_numero", x => x.Id);
                    table.ForeignKey(
                        name: "FK_limites_numero_loterias_LoteriaId",
                        column: x => x.LoteriaId,
                        principalTable: "loterias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_limites_numero_sorteos_SorteoId",
                        column: x => x.SorteoId,
            ...
            migrationBuilder.CreateTable(
                name: "resultados_sorteo",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SorteoId = table.Column<Guid>(type: "uuid", nullable: false),
                    Fecha = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Primera = table.Column<int>(type: "integer", nullable: false),
                    Segunda = table.Column<int>(type: "integer", nullable: false),
                    Tercera = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resultados_sorteo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_resultados_sorteo_sorteos_SorteoId",
                        column: x => x.SorteoId,
                        principalTable: "sorteos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SorteoId = table.Column<Guid>(type: "uuid", nullable: false),
                    FechaSorteo = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    TipoJugada = table.Column<int>(type: "integer", nullable: false),
                    PrimerNumero = table.Column<int>(type: "integer", nullable: false),
                    SegundoNumero = table.Column<int>(type: "integer", nullable: true),
                    TercerNumero = table.Column<int>(type: "integer", nullable: true),
                    SegundoSorteoId = table.Column<Guid>(type: "uuid", nullable: true),
                    Monto = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    MultiplicadorPago = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    MontoPremio = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_detalles_ticket_sorteos_SegundoSorteoId",
                        column: x => x.SegundoSorteoId,
                        principalTable: "sorteos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_detalles_ticket_sorteos_SorteoId",
                        column: x => x.SorteoId,
                        principalTable: "sorteos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_acumulados_venta_numero_SorteoId_Fecha_Numero",
                table: "acumulados_venta_numero",
                columns: new[] { "SorteoId", "Fecha", "Numero" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_configuraciones_pago_LoteriaId_TipoJugada",
                table: "configuraciones_pago",
                columns: new[] { "LoteriaId", "TipoJugada" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_cuadres_terminal_TerminalId_FechaCuadre",
                table: "cuadres_terminal",
                columns: new[] { "TerminalId", "FechaCuadre" });

            migrationBuilder.CreateIndex(
                name: "IX_detalles_ticket_SegundoSorteoId",
                table: "detalles_ticket",
                column: "SegundoSorteoId");

            migrationBuilder.CreateIndex(
                name: "IX_detalles_ticket_SorteoId_FechaSorteo",
                table: "detalles_ticket",
                columns: new[] { "SorteoId", "FechaSorteo" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_limites_numero_LoteriaId",
                table: "limites_numero",
                column: "LoteriaId");

            migrationBuilder.CreateIndex(
                name: "IX_limites_numero_SorteoId_Numero",
                table: "limites_numero",
                columns: new[] { "SorteoId", "Numero" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_resultados_sorteo_SorteoId_Fecha",
                table: "resultados_sorteo",
                columns: new[] { "SorteoId", "Fecha" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_sorteos_LoteriaId",
                table: "sorteos",
                column: "LoteriaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tickets_TerminalId_FechaCreacion",
                table: "tickets",
                columns: new[] { "TerminalId", "FechaCreacion" });

            migrationBuilder.CreateIndex(
                name: "IX_tickets_TerminalPagoId",
                table: "tickets",
                column: "TerminalPagoId");
        }
